...
*/
    ...
    */
    ...
    public void findDtoByJPQL() {
        List<MemberDto> result = em.createQuery("select new study.querydsl.dto.MemberDto(m.username, m.age) from Member as m",
                        MemberDto.class)
                .getResultList();
    ...
    // DTO 조회 -> querydsl의 setter 방식 -> 기본생성자 만들기 or NoArgConst~넣어주셈
    @Test
    ...
    // DTO 조회 (User) 이름이 다를 경우, .as("이름") 넣으셈
    @Test
    ...
    //DTO 조회 -> querydsl의 생성자(Constructor)
    @Test
    ...
    public void findDtoByQueryProjection() {
        ...
        for (MemberDto o : result) {
            System.out.println("o = " + o);
        }
    }

    // 동적 쿼리 해결 시작 - booleanBuilder
    ...
    private List<Member> searchMember2(String usernameCond, Integer ageCond) {
        ...
        return queryFactory
                .selectFrom(member)
//                .where(usernameEq(usernameCond), ageEq(ageCond)) // 요기가 다름
                .where(allEq(usernameCond, ageCond)) // 위의 코드와 동일함.
                .fetch();
    }
    ...
    // 삼항 연산자 : null이 아니면 앞에꺼, null이면 null 그대로.
    // 조립하기 위해서는 Predicate가 아닌 BooleanExpression을 써야함.
